...
export default function RefundPolicyPage() {
  return (
    <LegalPage title="Refund & Cancellation Policy" effectiveDate="[Effective date to be filled in]">
      ...
      <h3>Refunds</h3>
      <p>
        Since payment is made on delivery, there is typically nothing to refund for a cancelled order. If an
        item was paid for and later needs to be returned (for example, it arrived damaged or not as described),
        the return and refund is between you and the business, on that business&apos;s own return policy.
        Markkito encourages every business to state its return/refund terms clearly on its storefront, but is
        not a party to that policy and does not guarantee, hold, or process any refund.
      </p>

      <h2>3. Classifieds Purchases</h2>
      <p>
        Classifieds items are sold directly between a buyer and a seller, &quot;as described&quot; by the
        seller. Markkito strongly recommends inspecting an item in person before paying. Because Markkito is
        not a party to the sale, it has no obligation to and cannot process a refund for a classifieds purchase.
        If an item was misrepresented or a seller has acted fraudulently, you may report the listing or the user
        from the listing page, or contact us at <Ph>[support email]</Ph> — we may remove the listing or suspend
        the account, but any refund must be pursued directly with the seller, including through applicable
        consumer remedies where the seller is a business.
      </p>
      ...
      <h2>5. Disputes</h2>
      <p>
        If you&apos;re unable to resolve a payment or refund issue directly with a business or seller, you may
        raise it with our Grievance Officer — see <a href="/grievance">Grievance Redressal</a> — and, where the
        other party is a registered business on the Platform, we will make reasonable efforts to put you in
        touch with them and may take action against a listing or account found to be acting in bad faith.
      </p>

      <h2>6. Changes to This Policy</h2>
      <p>
        This policy will be updated if Markkito begins collecting payments directly (for example, if online
        payment is added to storefront checkout in future), at which point this page will set out the
        applicable refund timelines and process.
      </p>
    </LegalPage>
  );
}
