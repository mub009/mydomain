...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy" effectiveDate="[Effective date to be filled in]">
      <p>
        This Privacy Policy explains how <Ph>[Legal entity name]</Ph> (&quot;Markkito&quot;, &quot;we&quot;,
        &quot;us&quot;, &quot;our&quot;) collects, uses, shares, and protects information when you use the
        Markkito platform (the &quot;Platform&quot;). It is drawn up with reference to the Information
      ...
      <ul>
        <li>
          ...
          Platform&apos;s analytics dashboard for administrators (for example, &quot;online now&quot; and
          &quot;most-visited pages&quot;).
        </li>
        <li>
      ...
      <p>
        We use your browser&apos;s local storage to remember things like your saved location, recently viewed
        items, login session, and consent choices. We do not currently use third-party advertising cookies.
      </p>
      ...
      <ul>
        <li>
          ...
          message a seller, book a service, or place an order, the relevant contact and order details are
          shared with that business or user so the transaction can proceed.
        </li>
        <li>
      ...
      <p>
        ...
        &quot;Effective date&quot; above, and, where required by law, we will notify you by other reasonable
        means.
      </p>
