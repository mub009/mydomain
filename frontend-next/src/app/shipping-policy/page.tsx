  ...
  return (
    <LegalPage title="Shipping & Delivery Policy" effectiveDate="[Effective date to be filled in]">
      ...
      <p>
        ...
        contact us at <Ph>[support email]</Ph>. Markkito may investigate and take action against a listing found
        to be misleading customers about delivery, including suspension, but cannot itself arrange delivery or
        compensate for a missed shipment.
      </p>

      <h2>4. Changes to This Policy</h2>
      <p>This policy will be updated if Markkito introduces its own logistics or fulfilment service in future.</p>
    </LegalPage>
  );
}
