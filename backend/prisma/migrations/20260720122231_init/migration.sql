...
<<<<<<< HEAD:backend/prisma/migrations/20260720120000_init/migration.sql
    `state` VARCHAR(50) NOT NULL,
=======
    `state` VARCHAR(100) NOT NULL,
>>>>>>> 70d236f4b17a6892db8e79e87539afb4dfb8d4af:backend/prisma/migrations/20260720122231_init/migration.sql
