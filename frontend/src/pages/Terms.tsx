...
export default function Terms() {
  return (
    <LegalPage title="Terms of Use" effectiveDate="[Effective date to be filled in]">
      <p>
        These Terms of Use ("Terms") govern access to and use of the Markkito platform, including the website,
        mobile-optimised web app, and any related services (collectively, the "Platform"), operated by{" "}
        <Ph>[Legal entity name, e.g. XYZ Technologies Private Limited]</Ph>, a company incorporated under the
        Companies Act, 2013, having its registered office at <Ph>[Registered office address]</Ph>
        {" "}("Markkito", "we", "us", or "our"). By accessing or using the Platform, you agree to be bound by
        these Terms, our{" "}
        <a href="/privacy">Privacy Policy</a>, and any other policies referenced herein. If you do not agree, you
      ...
      <p>
        ...
        infringe any third party's rights. Markkito does not verify every listing before publication and does
        not guarantee the accuracy, quality, or legality of any business, product, or service listed. A
        "Verified" badge, where shown, reflects that a listing has passed a specific check described at the time
        it is awarded — it is not a general guarantee of the business's conduct.
      </p>
      ...
      <p>
        The Markkito name, logo, and the Platform's software, design, and underlying code are the property of{" "}
        <Ph>[Legal entity name]</Ph> or its licensors. Content you upload (business details, photos, listings,
        reviews) remains yours, but by posting it you grant Markkito a non-exclusive, royalty-free, worldwide
        licence to host, display, and distribute it as part of operating the Platform.
      </p>

      <h2>11. Third-Party Services</h2>
      <p>
        The Platform links to or integrates third-party services (for example, WhatsApp for buyer-seller contact,
        and map or location services). Markkito is not responsible for the content, policies, or practices of
      ...
      <p>
        ...
        implied, including merchantability, fitness for a particular purpose, and non-infringement. Markkito
        does not warrant that the Platform will be uninterrupted, error-free, or secure, or that any listing,
        review, or item description is accurate.
      </p>
      ...
      <p>
        ...
        the courts at <Ph>[City, State — e.g. Malappuram, Kerala]</Ph> shall have exclusive jurisdiction over any
      ...
      <p>
        ...
        "Effective date" above. Continued use of the Platform after a change takes effect constitutes acceptance
